// Ported from the website's src/utils.js — keep the logic identical so the
// app and site agree on filtering. Only the style values differ (theme
// colors instead of Tailwind classes).
...
export const STATUS_STYLES = {
  ...
  closed: {
    ...
    badgeText: colors.red800,
    dot: colors.red500,
  },
  transitioning: {
    label: 'Transitioning',
    badgeBg: colors.amber100,
